...
$table->head = array(
    'STUDENT ID', 'TERM','COURSE ID','COURSE NAME','QUIZZES','ASSIGNMENT','MID TERM MARKS','PRESENTATIONS'
);
...
FROM BSEM_RESULTS BS,
     BCOURSE BE
      
      
WHERE   BE.COURSE_ID=BS.COURSE_ID
AND     STUDENT_ID=?
AND     CURR_SEM='Y'
";
...
foreach ($rs as $backuprow) {
    ...
    $cells = array(
        ...
        $backuprow->quizzes,
        $backuprow->assignment,
		$backuprow->midtermmarks,
        $backuprow->presentations
...
</style><div id="st">Semester Result </div>
...
printWindow.document.write("<div style=\"position:relative; left:20px; top:50px\"><br/><br/><br/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<img src=\"logo.png\" align=\"center\"/><font size=\"25\" face=\"arial\" color=\"black\">Riphah International University</font><br/><br/><br/>"+"<hr/><font size=\"8\" face=\"arial\" color=\"black\">Semester Result Report</font><br/><br/>"+
