...
$table->head = array(
    'STUDENT ID', 'TERM','SUBMISSION TIME','DEBIT','CREDIT','DESCRIPTION','VERIFICATION'
);
$table->headspan = array(1, 1, 1, 1,1,1,1);
$table->data = array();
...
foreach ($rs as $backuprow) {
    ...
    $cells = array(
		...
		$backuprow->term,
        $backuprow->submit_date,
        $backuprow->debit,
        $backuprow->credit,
        $backuprow->description,
        $backuprow->verification_status
...
if (empty($table->data)) {
    $cell = new html_table_cell($OUTPUT->notification("No Financial data yet!"));
    $cell->colspan = 7;
...
echo $OUTPUT->header();
echo '<a href="financialrecord.php" onClick="printpage();return false"><img src="print.jpg" align="right"></a>';
...
</style><div id="st">Financial Record </div>
...
printWindow.document.write("<div style=\"position:relative; left:20px; top:50px\"><br/><br/><br/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<img src=\"logo.png\" align=\"center\"/><font size=\"25\" face=\"arial\" color=\"black\">Riphah International University</font><br/><br/><br/>"+"<hr/><font size=\"8\" face=\"arial\" color=\"black\">Financial Record Report</font><br/><br/>"+
